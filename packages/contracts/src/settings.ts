...
export const AgentNotificationMode = Schema.Literals(["off", "on", "when-not-focused"]);
export type AgentNotificationMode = typeof AgentNotificationMode.Type;
export const DEFAULT_AGENT_NOTIFICATION_MODE: AgentNotificationMode = "when-not-focused";
...
export const ClientSettingsSchema = Schema.Struct({
  agentNotificationMode: AgentNotificationMode.pipe(
    Schema.withDecodingDefault(Effect.succeed(DEFAULT_AGENT_NOTIFICATION_MODE)),
  ),
...
export const ServerSettings = Schema.Struct({
  ...
  builderModelSelection: ModelSelection.pipe(
    Schema.withDecodingDefault(
      Effect.succeed({
        instanceId: ProviderInstanceId.make("codex"),
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  builderModelSelection: Schema.optionalKey(ModelSelectionPatch),
...
export const ClientSettingsPatch = Schema.Struct({
  agentNotificationMode: Schema.optionalKey(AgentNotificationMode),
