...
export const SubagentModelsTool = Tool.make("subagent_models", {
  ...
  parameters: SubagentListRequest,
...
export const SubagentWaitTool = Tool.make("subagent_wait", {
  description:
    "Wait for all selected T3-managed children to settle and consume their pending results. Waiting does not stop children when the MCP request is cancelled.",
