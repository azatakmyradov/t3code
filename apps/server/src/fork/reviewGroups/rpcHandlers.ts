...
import type { ReviewServiceShape } from "../../review/ReviewService.ts";
...
export interface ForkReviewGroupsDeps {
  readonly review: Pick<ReviewServiceShape, "getDiffPreview">;
  readonly providerInstances: Pick<ProviderInstanceRegistryShape, "getInstance">;
...
const groupSemanticDiff = (deps: ForkReviewGroupsDeps) => (input: ReviewSemanticGroupsInput) =>
  Effect.gen(function* () {
