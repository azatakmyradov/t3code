...
| [Builder model selection](changes/2026-06-16-builder-model-selection.md)                             | Contracts, server/shared settings, web composer, settings | Adds `builderModelSelection` + an "Implement with builder" plan action.                            |
